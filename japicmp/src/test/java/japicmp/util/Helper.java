...
public class Helper {
	...
	public static Matcher<JApiClass> hasJApiMethodWithName(final String methodName) {
		return new TypeSafeMatcher<JApiClass>() {
			...
			public void describeTo(Description description) {
				description.appendText("JApiClass should have a method with name '").appendValue(methodName).appendText("'.");
			}
	...
	public static Matcher<JApiClass> hasNoJApiMethodWithName(final String methodName) {
		return new TypeSafeMatcher<JApiClass>() {
			...
			@Override
			public void describeTo(Description description) {
				description.appendText("JApiClass should not have a method with name '").appendValue(methodName).appendText("'.");
			}
	...
	public static Matcher<JApiClass> hasNoJApiFieldWithName(final String fieldName) {
		return new TypeSafeMatcher<JApiClass>() {
			...
			@Override
			public void describeTo(Description description) {
				description.appendText("JApiClass should not have a field with name '").appendValue(fieldName).appendText("'.");
			}
